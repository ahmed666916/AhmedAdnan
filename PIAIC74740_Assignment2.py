...
def function2():
    ...
    x = np.arange(10, 37, dtype=np.float64).reshape(
        (3, 3, 3))  # wrtie your code here
...
def function3():
    ...
    # example [35,70,105,..]
    a = np.arange(start=35, stop=1000, step=35)
...
def function8():
    ...
    x = np.array([[6, 6, 6, 6, 6], [6, 6, 6, 6, 6]], dtype=np.uint32)
